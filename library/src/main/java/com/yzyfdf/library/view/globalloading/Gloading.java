...
public class Gloading {
    ...
    public interface Adapter {
         ...
         * @see Holder
         */
        View getView(Holder holder, View convertView, int status, int icon, int str);
    }
    ...
    public static class Holder {
        ...
        /**
         * set extension data. maybe we need this data within {@link Adapter#getView(Holder, View, int, int, int)}
         *
        ...
        public void showLoading() {
            showLoadingStatus(STATUS_LOADING, 0, 0);
        }
        ...
        public void showLoadSuccess() {
            showLoadingStatus(STATUS_LOAD_SUCCESS, 0, 0);
        }
        ...
        public void showLoadFailed() {
            showLoadingStatus(STATUS_LOAD_FAILED, 0, 0);
        }

        public void showLoadFailed(@StringRes int str) {
            showLoadingStatus(STATUS_LOAD_FAILED, 0, str);
        }

        public void showLoadFailed(@DrawableRes int icon, @StringRes int str) {
        ...
        public void showEmpty() {
            showLoadingStatus(STATUS_EMPTY_DATA, 0, 0);
        }

        public void showEmpty(@StringRes int str) {
            showLoadingStatus(STATUS_EMPTY_DATA, 0, str);
        }

        public void showEmpty(@DrawableRes int icon, @StringRes int str) {
         ...
         * @see #showEmpty()
         */
        private void showLoadingStatus(int status, @DrawableRes int icon, @StringRes int str) {
            ...
            try {
                ...
                View view = mAdapter.getView(this, convertView, status, icon, str);
                if (view == null) {
